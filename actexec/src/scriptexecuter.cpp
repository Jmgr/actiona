...
ScriptExecuter::ScriptExecuter(QObject *parent) :
	...
	mExecuter(new Execution::Executer(this))
{
    connect(mExecuter, &Execution::Executer::executionStopped, this, &ScriptExecuter::executionStopped);
    connect(mExecuter, &Execution::Executer::scriptError, this, &ScriptExecuter::scriptError);
}
...
bool ScriptExecuter::start(QIODevice *device, const QString &filename)
{
    ...
    mExecuter->setup(mScript, actionFactory(), false, 0, 0, false, 0, 0, Global::ACTIONA_VERSION, Global::SCRIPT_VERSION, true, nullptr, 0);

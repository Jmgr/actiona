...
#ifndef CODERAWDATA_H
#define CODERAWDATA_H
...
class CodeRawData : public QObject, public QScriptable
{
    Q_OBJECT

public:
	static QScriptValue constructor(QScriptContext *context, QScriptEngine *engine);
	static QScriptValue constructor(const CodeRawData &other, QScriptContext *context, QScriptEngine *engine);
	static QScriptValue constructor(const QByteArray &byteArray, QScriptContext *context, QScriptEngine *engine);
	
	CodeRawData();
	CodeRawData(const CodeRawData &other);
	CodeRawData(const QByteArray &byteArray);
	
	CodeRawData &operator=(CodeRawData other);
	CodeRawData &operator=(QByteArray byteArray);
	
	void swap(CodeRawData &other);

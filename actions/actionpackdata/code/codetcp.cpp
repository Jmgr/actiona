...
QScriptValue CodeTcp::constructor(QScriptContext *context, QScriptEngine *engine)
{
	Q_UNUSED(context)
	
	return engine->newQObject(new CodeTcp, QScriptEngine::ScriptOwnership);
}
...
QScriptValue CodeTcp::connect(const QString &hostname, quint16 port, OpenMode openMode)
{
...
QScriptValue CodeTcp::waitForConnected(int waitTime)
{
...
QScriptValue CodeTcp::waitForBytesWritten(int waitTime)
{
...
QScriptValue CodeTcp::waitForReadyRead(int waitTime)
{
...
QScriptValue CodeTcp::waitForDisconnected(int waitTime)
{
...
QScriptValue CodeTcp::write(const QScriptValue &data)
{
...
QScriptValue CodeTcp::writeText(const QString &data, Code::Encoding encoding)
{
...
QScriptValue CodeTcp::read()
{
	return CodeRawData::constructor(mTcpSocket.readAll(), context(), engine());
}

QString CodeTcp::readText(Code::Encoding encoding)
{
	return Code::fromEncoding(mTcpSocket.readAll(), encoding);
}

QScriptValue CodeTcp::disconnect()
{
	mTcpSocket.disconnectFromHost();

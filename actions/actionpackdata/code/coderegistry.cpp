...
QScriptValue CodeRegistry::openKey(Key key, const QString &subKey)
{
#ifdef Q_WS_WIN
...
QScriptValue CodeRegistry::createKey(Key key, const QString &subKey)
{
#ifdef Q_WS_WIN
	HKEY hKey = enumToKey(key);
...
QScriptValue CodeRegistry::setValue(const QString &value, const QVariant &data) const
{
#ifdef Q_WS_WIN
...
QVariant CodeRegistry::value(const QString &value) const
{
#ifdef Q_WS_WIN
	DWORD size;
	DWORD type;
...
QScriptValue CodeRegistry::deleteKey(Key key, const QString &subKey) const
{
#ifdef Q_WS_WIN
	HKEY hKey = enumToKey(key);
...
QScriptValue CodeRegistry::deleteKey() const
{
#ifdef Q_WS_WIN
	RegCloseKey(mHKey);
...
#ifdef Q_WS_WIN
HKEY CodeRegistry::enumToKey(Key key) const
{
	switch(key)
	{
	case ClassesRoot:

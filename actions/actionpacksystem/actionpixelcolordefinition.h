...
#ifndef ACTIONPIXELCOLORDEFINITION_H
#define ACTIONPIXELCOLORDEFINITION_H

#include "actiondefinition.h"
#include "actionpixelcolorinstance.h"
...
class ActionPixelColorDefinition : public QObject, public ActionTools::ActionDefinition
{
   Q_OBJECT
...
public:
	...
	ActionTools::ActionInstance *newActionInstance() const					{ return new ActionPixelColorInstance(this); }
...
private:
	Q_DISABLE_COPY(ActionPixelColorDefinition)
};

#endif // ACTIONPIXELCOLORDEFINITION_H

...
namespace ActionTools
{
    ...
    class ACTIONTOOLSSHARED_EXPORT CodeDoubleSpinBox : public QDoubleSpinBox, public AbstractCodeEditor
	{
		Q_OBJECT

	public:
        explicit CodeDoubleSpinBox(QWidget *parent = nullptr);
	...
	private:
        ...
        Q_DISABLE_COPY(CodeDoubleSpinBox)
	};
}

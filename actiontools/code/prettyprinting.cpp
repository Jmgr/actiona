...
namespace Code
{
    ...
    void setupPrettyPrinting(QScriptEngine &scriptEngine)
    {
        ...
        QScriptValue arrayPrototypeScriptValue = scriptEngine.globalObject().property("Array").property("prototype");
        arrayPrototypeScriptValue.setProperty("toString", scriptEngine.newFunction(toStringFunction));
        QScriptValue objectPrototypeScriptValue = scriptEngine.globalObject().property("Object").property("prototype");
        objectPrototypeScriptValue.setProperty("toString", scriptEngine.newFunction(toStringFunction));
    }
}

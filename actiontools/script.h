...
namespace ActionTools
{
	...
	public:
		...
		ReadResult read(QIODevice *device, const Tools::Version &scriptVersion, std::function<void()> *resetCallback = nullptr, std::function<void(ActionInstance *)> *addActionCallback = nullptr);

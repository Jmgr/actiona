...
namespace Backend
{
    ...
    AreaChooserWindows::AreaChooserWindows(QObject *parent):
        AreaChooser(parent)
    {
    }

    AreaChooserWindows::~AreaChooserWindows()
    {
    }

    void AreaChooserWindows::choose()
    {
        auto target = new TargetWindow;
        connect(target, &TargetWindow::rectangleSelected, this, &AreaChooserWindows::done);
        target->show();
    }
}
